import { ImageBackground, Keyboard, StyleSheet, Text, TouchableOpacity,TextInput, View } from 'react-native'
...
const EditProfileScreen = () => {
  ...
  const handleUpdate = async () => {
    ...
    const filename = Uri.uri.substring(Uri.uri.lastIndexOf('/')+1);
  ...
  return (
    <View style={styles.container}>
      <View style={{margin: 20}}>
        ...
        <View style={styles.action}>
        <MaterialCommunityIcons name="map-marker-outline" color="#333333" size={20} />
          <TextInput
